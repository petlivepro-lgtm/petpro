...
insert into product (tenant_id, name, description, price_cents, stock)
values
  ('00000000-0000-0000-0000-0000000000a1', 'Ração Premium 1kg', 'Ração super premium', 4500, 25),
  ('00000000-0000-0000-0000-0000000000a1', 'Brinquedo Mordedor', 'Mordedor resistente', 2900, 40),
  ('00000000-0000-0000-0000-0000000000a1', 'Shampoo Neutro 500ml', 'Shampoo hipoalergênico', 3200, 15)
on conflict do nothing;
